...
const dict = {
  ...
  en: {
    ...
    home: {
      intro: 'Photographs from the north of Greece.',
      seriesLabel: 'Series',
      enter: 'Enter',
    ...
    portfolio: {
      title: 'Portfolio',
      lead: 'Fourteen series. Twelve photographs each.',
      photos: 'photographs',
    ...
    services: {
      title: 'Services',
      lead: 'Alongside the personal work, Panagiota takes commissions. Same eye, quiet and attentive.',
      cta: 'Get a quote',
